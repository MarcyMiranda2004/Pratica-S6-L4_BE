...
import it.epicode.Pratica_S6_L4.payloads.NewBlogPostPayload;
import it.epicode.Pratica_S6_L4.services.BlogsService;
...
public class BlogsController {
    ...
    public Blogpost saveBlog(@RequestBody @Valid NewBlogPostPayload body) {
